...
<head>
  ...
  <?php if ($_SESSION["computer"] === "pc") { ?>
    ...
    <?php } elseif ($_SESSION["computer"] === "phone") { ?>
      <link rel="stylesheet" href="frontend1_phone.css">
  <?php } ?>
  ...
  <?php } elseif ($_SESSION["computer"] === "phone") { ?>
    <div class="phone_header">
      ...
      <nav class="globalMenuSp">
        <ul>
            <li><a href="#">Home</a></li>
            <li><a href="http://co-19-216.99sv-coco.com/lcc/service/home.html">Service</a></li>
            <li><a href="#">Blog</a></li>
...
<!-- 質問表示div -->
  <div class="questions_div">
    <!-- formのようい -->
    <form method="post" action="http://co-19-246.99sv-coco.com/lcc/service/frontend/frontend1.php" name="form" onsubmit="return formCheck()">
